...
export type BillingCycle = 'OneTime' | 'Monthly' | 'Quarterly' | 'SemiAnnually' | 'Annually' | 'Biennially' | 'Triennially';
export type InvoiceStatus = 'Draft' | 'Unpaid' | 'Paid' | 'PartiallyPaid' | 'Overdue' | 'Cancelled' | 'Refunded';
